...
# Load the pipeline
pipe = pickle.load(open('pkl_rp.pkl', 'rb'))

teams = ['India', 'Pakistan', 'Australia', 'South Africa', 'New Zealand', 'England', 
         'Bangladesh', 'Sri Lanka', 'Afghanistan', 'Netherlands']
